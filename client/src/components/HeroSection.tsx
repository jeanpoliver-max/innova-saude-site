...
export default function HeroSection() {
  ...
  return (
    <section id="inicio" className="relative overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50/30 to-white">
      {/* Decorative blobs */}
      <div className="absolute top-[-20%] right-[-10%] w-[600px] h-[600px] rounded-full bg-[#5B9BD5]/10 blur-3xl pointer-events-none" />
      <div className="absolute bottom-[-30%] left-[-15%] w-[500px] h-[500px] rounded-full bg-[#7AB929]/10 blur-3xl pointer-events-none" />
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center min-h-[calc(100vh-80px)] py-12 lg:py-0">
          ...
          >
            <div className="relative">
              {/* Decorative ring */}
              <div className="absolute -inset-4 bg-gradient-to-br from-[#5B9BD5]/30 to-[#7AB929]/20 rounded-[2rem] blur-xl" />
              <div className="relative rounded-[1.5rem] overflow-hidden shadow-2xl shadow-[#1B4F7A]/15">
                <img
                  ...
                  loading="eager"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#1B4F7A]/20 via-transparent to-transparent" />
              </div>
              ...
              <motion.div
                ...
                className="absolute -bottom-6 -left-6 bg-white rounded-2xl p-4 shadow-xl shadow-slate-900/10 border border-[#5B9BD5]/20"
              >
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#5B9BD5] to-[#7AB929] flex items-center justify-center">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-[#7AB929]">Diagnóstico POCT</div>
                  </div>
                </div>
              </motion.div>
            </div>
